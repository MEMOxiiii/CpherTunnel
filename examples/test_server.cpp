...
using namespace bedrock::network;
using namespace bedrock::raknet;
...
int main(int argc, char* argv[]) {
    ...
    auto logPacketSize = [](const char* name, const bedrock::Packet& pkt) {
            ...
            switch (evt.type) {
                ...
                case ConnectionEvent::Type::PacketReceived: {
                    ...
                    case PacketId::RequestNetworkSettings: {
                        ...
                        auto* bc = handler->getBedrockConnection(evt.address);
                        if (bc) {
