...
public:
    ...
    void writeUint24LE(uint32_t value) {
        uint8_t buf[3];
        cphertunnel::raknet::writeUint24LE(buf, value);
        writeBits(buf, 24);
    }
    ...
    void writeUint64BE(uint64_t value) {
        uint8_t buf[8];
        cphertunnel::raknet::writeInt64BE(buf, value);
        writeBits(buf, 64);
    }
    ...
    uint32_t readUint24LE() {
        uint8_t buf[3];
        readBits(buf, 24);
        return cphertunnel::raknet::readUint24LE(buf);
    }
    ...
    uint64_t readUint64BE() {
        uint8_t buf[8];
        readBits(buf, 64);
        return cphertunnel::raknet::readInt64BE(buf);
    }
