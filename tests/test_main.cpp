// =============================================================================
// BedrockProtocol - Comprehensive Test Suite
...
TEST(binarystream_uuid) {
    BinaryStream write;
    bedrock::UUID uuid{0x12345678ABCDEF01ULL, 0xFEDCBA9876543210ULL};
    write.writeUUID(uuid);
    
    ReadOnlyBinaryStream read(write.getBuffer());
    bedrock::UUID result = read.readUUID();
...
int main() {
    std::cout << "========================================" << std::endl;
    std::cout << "BedrockProtocol Test Suite" << std::endl;
